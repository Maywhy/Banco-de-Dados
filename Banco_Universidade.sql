...
CREATE TABLE prof_disciplina (
   ...
   CONSTRAINT fk_disc_m    FOREIGN KEY (codDisciplina) 	REFERENCES disciplina(codDisciplina),
...
INSERT INTO professor VALUES (null, 'Valdir Vidente', 'vv@escola.com', '91234-5671', 80);
INSERT INTO professor VALUES (null, 'Margarete Tatcher', 'mt@escola.com', '91234-5672', 100);
